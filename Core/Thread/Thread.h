...
namespace Online::Core
{
    ...
    public:
        ...
        Online::Core::Thread::Identifier GetThreadId() noexcept
        {
    ...
    public:
        static Online::Core::Thread::Identifier GetCurrentThreadId() noexcept
        {
...
{
    template <>
    struct hash<::Online::Core::Thread::Identifier>
    {
        size_t operator()(const ::Online::Core::Thread::Identifier& id) const noexcept
        {
