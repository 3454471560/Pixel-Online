...
namespace Online::Core
{
    ...
    public:
        ...
        [[nodiscard]] static constexpr StateFlags Full() noexcept
        {
            StateFlags ret;
            ret.state = ~std::underlying_type_t<TEnum>(0);
            return ret;
        }
    public:
    ...
    public:
        ...
        inline void SetBits(Args&&... args) noexcept
        {
            ...
            state |= Online::Core::CombineMask<TEnum>(std::forward<Args>(args)...);
        }
        ...
        inline void OverwriteFrom(const StateFlags& other) noexcept
        {
            state = other.state;
        }
        ...
        inline bool HasAllBits(Args&&... args) const noexcept
        {
            ...
            std::underlying_type_t<TEnum> combinedMask = Online::Core::CombineMask<TEnum>(std::forward<Args>(args)...);
